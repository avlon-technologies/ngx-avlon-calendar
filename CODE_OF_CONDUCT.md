...
This Code of Conduct applies in all community spaces, and also when an
...
maintainers at **conduct@avlon.ca**. All complaints will be reviewed and
investigated promptly and fairly. Maintainers must respect the privacy and
security of whoever reports an incident.
...
1. **Correction.** A private, written warning, with clarity about the nature of
   the violation and why it was inappropriate. A public apology may be requested.
2. **Warning.** A warning with consequences for continued behaviour, including no
